...
public class CustomAdapter extends ArrayAdapter<RowItem> {
     ...
     * @param rowitems A List of AndroidFlavor objects to display in a list
     */
    public CustomAdapter(Activity context, List<RowItem> rowitems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RowItem androidFlavor = getItem(position);
        ...
        Picasso.with(getContext()).load("http://image.tmdb.org/t/p/w342//"+androidFlavor.getPic()).into(iconView);
